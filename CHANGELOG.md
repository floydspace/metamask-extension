...
- Add token list aggregattor to token details page ([#14051](https://github.com/MetaMask/metamask-extension/pull/14051))
...
- Improvements for multi-layer fee UX ([#13547](https://github.com/MetaMask/metamask-extension/pull/13547))
    - "Send max" doesn't work on Optimism
    - Show currency estimate alongside ETH on Optimism
    - Combine L1+L2 gas when using Optimism
...
- Fixed issue where the "lock screen" shows up briefly between the "create password" screen and the success screen ([#14111](https://github.com/MetaMask/metamask-extension/pull/14111))
- Add space between sentences in insufficient currency warning ([#14019](https://github.com/MetaMask/metamask-extension/pull/14019))
...
- Fix missing insufficient funds error for token sends ([#14026](https://github.com/MetaMask/metamask-extension/pull/14026))
